...
public class create {
    ...
    public void selectMethod(String toGet){
        ...
        try
        {
            ...
            ResultSet rs1 = stmt.executeQuery("Describe "+toGet);
            int count = 0;
            ...
            ResultSet rs = st.executeQuery("Select * from "+toGet);
            System.out.println("");
            while (rs.next())
            {
    ...
    public void updateRecord(String toUpt){
    ...
    public String use(String option) throws SQLException {
    ...
    public String alterDatabase(String name, int toExcute){
        try{
            Connection conn = DriverManager.getConnection(mysqlUrl,userName,passWord);
            Statement stmt = conn.createStatement();
            if (toExcute==1){
