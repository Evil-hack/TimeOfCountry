...
//            Class.forName("com.mysql.cj.jdbc.Driver");
    ...
    static void inMain() throws SQLException {
        login();
        ...
        while (!option.equals("bye")) {
            if (option.equalsIgnoreCase("show databases")) {
                ...
                if (option.split(" ").length==3){
                    System.out.println(create.alterDatabase(option.split(" ")[2],1));
                }
                else {
                ...
                if (option.split(" ").length==3){
                    System.out.println(create.alterDatabase(option.split(" ")[2],2));
                }
                else {
                    System.out.println("Check your syntax.");
                }
                ...
                if (option.split(" ").length==2){
                    System.out.println(create.use(option.split(" ")[1]));
                }else {
                    System.out.println("Check your syntax.");
                }
            }
                ...
                create.selectMethod(option.split(" ")[3]);
            }


            else if (option.split(" ")[0].equalsIgnoreCase("UPDATE")) {
                create.updateRecord(option);
            }
